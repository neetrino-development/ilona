...
export default function TeacherChatPage() {
        ...
        setChats([
          {
            ...
            participants: [
              {
                userId: user?.id || '1',
                user: { id: user?.id || '1', firstName: 'Sarah', lastName: 'Jenkins', role: 'TEACHER' },
                unreadCount: 0,
              },
              { userId: '2', user: { id: '2', firstName: 'Anna', lastName: 'K.', role: 'STUDENT' }, unreadCount: 0 },
              { userId: '3', user: { id: '3', firstName: 'Michael', lastName: 'B.', role: 'STUDENT' }, unreadCount: 0 },
            ],
            lastMessage: {
  ...
  const handleSendVocabulary = () => {
    if (!activeChat) return;
    const vocabContent = `📚 Today's Vocabulary:\n\nAdd your vocabulary words here...`;
    handleSendMessage(vocabContent, 'VOCABULARY');
  };
            ...
            {activeChat ? (
              <>
                ...
                <div className="absolute bottom-24 right-8">
                  <Button
                    onClick={handleSendVocabulary}
                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-full shadow-lg flex items-center gap-2"
                  >
              ...
              <div className="flex-1 flex items-center justify-center bg-slate-50">
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-500">Choose a group to send messages and vocabulary</p>
                </div>
              </div>
            )}
          </div>
